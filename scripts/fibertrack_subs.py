...
inDir = 'dti80trilin/bin'			# directory w/in diffusion data and b-gradient file and mask
...
seedStr = 'DAL'						# if false, will use the mask as seed ROI by default
...
roi2Strs = ['caudateL','putamenL']		# can be many or none; if not defined, fibers will just be tracked from the seed ROI
excPath = ''
