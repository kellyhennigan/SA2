...
pm_def.INPUT_DATA_FORMAT = 'PM';      % 'RI' = load two real and 
                                      ...
                                      % pairs.
pm_def.SHORT_ECHO_TIME = 9.1;        % Short echo time in ms for Allegra
pm_def.LONG_ECHO_TIME = 11.372;        % Long echo time in ms for Allegra
...
pm_def.TOTAL_EPI_READOUT_TIME = 26.0;   % Allegra EPI RO time (330E-6*64)
