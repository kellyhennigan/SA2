function VDM=FieldMap_preprocess(fmapB0Filenames,fmapMAGFilenames,funcRefFilenames,pm_defs,sessname)
%
% Function to prepare fieldmap data for processing
% 
% FORMAT VDM = FieldMap_preprocess(fmapB0Filenames,fmapMAGFilenames,funcRefFilenames,pm_defs,sessname)
...
% edited by Kelly for experiment SA2, 12/22/14
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

if nargin < 4
  error('Usage: FieldMap_preprocess(fm_phase_filename,fm_mag_filename,func_ref_vol_filename,pm_defs)');
end
...
if nargin<5
  ...
  pm_def.sessname=pm_def.sessname;
end
...
scphase = FieldMap('scale',fmapB0Filenames);
fm_imgs=char(scphase.fname,fmapMAGFilenames);
