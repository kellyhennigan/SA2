...
for subject in subjects:
	...
	cmd = 'align_epi_anat.py -anat t1+orig. -epi rcal1+orig. -epi_base 0 -epi2anat -partial_coverage -tlrc_apar t1+tlrc -anat_has_skull no -epi_strip 3dAutomask -big_move -master_tlrc 1.6 -tshift off -volreg off -AddEdge -child_epi ref.nii.gz run1_1_10+orig.'
	os.system(cmd)
	print 'done'
...
# 	cmd = 'align_epi_anat.py -anat t1+orig. -epi rcal1+orig. -epi_base 0 -anat2epi -partial_coverage -anat_has_skull no -epi_strip 3dAutomask -big_move -tshift off -volreg off -AddEdge'
# 	os.system(cmd)
