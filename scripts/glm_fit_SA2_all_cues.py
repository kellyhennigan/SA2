...
subject = '9'			# subject (string) to process
...
cmd = ('3dDeconvolve '
	...
	'-bucket '+res_dir+'glm_res ' 			# save out all info to filename w/prefix
	'-cbucket '+res_dir+'glm_B ') 			# save out only regressor coefficients to filename w/prefix
